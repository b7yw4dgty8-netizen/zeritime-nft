...
// Папка data/ хранит файл базы данных
...
// Включаем WAL-режим — база работает быстрее при частых записях
 ...
 * Возвращает { user, isNew } — isNew=true, если пользователь только что зарегистрировался.
 */
